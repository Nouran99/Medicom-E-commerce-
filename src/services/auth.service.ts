...
export class AuthService {
  ...
  // Request OTP
  async requestOTP(identifier: string, type: 'sms' | 'email'): Promise<{ success: boolean; message: string }> {
  ...
  // Verify OTP
  async verifyOTP(identifier: string, otp: string): Promise<{ success: boolean; token?: string; user?: any }> {
    const supabase = getSupabaseAdmin(this.c);
